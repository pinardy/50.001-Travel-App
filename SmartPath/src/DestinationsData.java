...
public class DestinationsData {
    ...
    private static final HashMap<Integer, String> modeOfTransport;
    private static final int DESTINATION_SIZE;
    ...
    static {
        DATAMAP.put("Marina Bay Sands", Integer.valueOf(0));
        DATAMAP.put("Singapore Flyer", Integer.valueOf(1));
        DATAMAP.put("Vivo City", Integer.valueOf(2));
        DATAMAP.put("Resorts World Sentosa", Integer.valueOf(3));
        DATAMAP.put("Buddha Tooth Relic Temple", Integer.valueOf(4));
        DATAMAP.put("Zoo", Integer.valueOf(5));
