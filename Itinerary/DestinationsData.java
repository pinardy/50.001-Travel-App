...
public class DestinationsData {
    ...
    private static final HashMap<Integer, String> modeOfTransport = new HashMap<>();
    static {
    ...
    private static final double[][][] COST = new double[3][DESTINATION_SIZE][DESTINATION_SIZE];
    ...
    private static final int[][][] TIME = new int[3][DESTINATION_SIZE][DESTINATION_SIZE];
    static{
        //Walking time
        TIME[0][0][1] = 14;
        TIME[0][0][2] = 69;
